...
* **CCPF_HOME/bin/ccpf-init** is a convenience script to download project files from a common repo.
...
* If a file named **before_configure.make-plugin.sh** exists in the project home directory,
  it is run right before the Makefile's configure target (*before* generating all artifacts).
* If a file named **after_configure.make-plugin.sh** exists in the project home directory,
  ...
  **after_configure.make-plugin.sh** can be generated by Jsonnet's processing of project.ccpf-defn.jsonnet.
...
* **.ccpf_migration.ccpf-defn.jsonnet_generated**, a text file that contains the list of files generated
